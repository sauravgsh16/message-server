...
func (ch *Channel) send(mf proto.MessageFrame) error {
	if ch.state == CH_CLOSED {
		return ch.sendClosed(mf)
	}
	if content, ok := mf.(proto.MessageContentFrame); ok {
...
func (ch *Channel) updateCurrentMessage(mcf proto.MessageContentFrame) *proto.Error {
...
func (ch *Channel) handleMethod(wf *proto.Frame) *proto.Error {
...
func (ch *Channel) handleHeader(wf *proto.Frame) *proto.Error {
	if ch.currentMessage == nil {
